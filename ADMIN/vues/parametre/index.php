...
<?php require_once("../header/header.php"); ?>
    ...
    <link rel="stylesheet" href=<?php echo parametre_CSS; ?> >
...
<body>
    ...
    <!----------------- Scripts -------------->
    <script>
        document.querySelector(".navigation ul li.linkParametre").classList.add("hovered");
    </script>
    <script src=<?php echo default_JS; ?>></script>
    <script src=<?php echo default_functions_JS; ?>></script>
    <script src=<?php echo parametre_JS; ?>></script>
